...
<div class="header">
	<div class="container">
		...
		<div class="col-md-4 header-right ">
			...
			<ul class="list-right">
                            <li><a href="prakashpambhar04@gmail.com">abhaysuchak4590@gmail.com</a></li>
				<li><a href="">www.abhaysuchak.com</a></li>
				<li>846-069-0566</li>
				<li> A-402 vrajbhumi Appartment , sitanagar,punagam,Surat.</li>
			</ul>
			<div class="clearfix"></div>
		</div>
		<div class="clearfix"></div>
...
<div id="about" class="about">
				...
				<div class="accordion">
							<div class="accordion-section">
								<h5><a class="accordion-section-title" href="#accordion-1">
									<span>2012 - 2014</span> Veer Narmad South Gujarat University
	...
	<div class="col-md-6 abt-right ">
		...
		<div class="col-sm-4 abt-gd-left text-center">		   
			<div id="demo-pie-4" class="pie-title-center" data-percent="80"> <span class="pie-value"></span> </div>
...
<div class="num-scroller">
	<div class="container">
		...
		<div class="col-md-3 capabil-grid text-center">
			...
			<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='1000' data-delay='.5' data-increment="100">50</div>
			<p>Projects Done</p>		
		</div>
		<div class="col-md-3 capabil-grid text-center">
					
			<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='1700' data-delay='.5' data-increment="5">100</div>
			<p>Testing</p>	
		</div>
		<div class="col-md-3 capabil-grid text-center" >
			
			<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='9000' data-delay='.5' data-increment="100">10</div>				
			<p>Clients</p>
		</div>
		<div class="col-md-3 capabil-grid text-center">			
			<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='2500' data-delay='.5' data-increment="1">210</div>
			<p>Likes</p>
		</div>
		<div class="clearfix"></div>
	</div>
...
<div id="emailme" class="contact">
	<div class="container">
				...
				<div class="tab-content">
					<div class="tab-pane active in" id="tab1">
						<div class="contact-form">
							<ul>
								<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>202 Netaldepark socity,punagam, <span>surat.</span></li>
								<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">prakashpambhar04@gmail.com</a></li>
								<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+91 8460 346 129</li>
							</ul>
							<form>
		...
		<div class="clearfix"></div>
		<p class="copy-right">&copy 2016 Resume. All rights reserved</p>
	</div>
</div>
<!-- //contact -->
